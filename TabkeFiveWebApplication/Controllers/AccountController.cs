...
namespace TabkeFiveWebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        [BotDetect.Web.Mvc.CaptchaValidation("CaptchaCode", "ExampleCaptcha", "Incorrect CAPTCHA code")]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (Request.Files["File1"] != null)
                {
                    ...
                    model.Pic = ImageContent;

                }

                var user = new ApplicationUser { UserName = model.Email, Email = model.Email ,Name=model.Name ,phNumber=model.phNumber,Pic=model.Pic,Birthday=model.Birthday,Introduction=model.Introductions};
